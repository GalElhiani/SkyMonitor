...
with open(file_path, "r", encoding="utf-8") as file:
    for line in file:
        clean_row = line.strip().split(",")                 #strip removes \n and split(",") for csv format
        csv_reader.append(clean_row)
...
print("average hospitalization: ", hospitalization_mean)

def filter_file(data_source, target_cols, output_file):
    '''a function that filters out specific data columns requested by the user'''
